...
void pre_auton(void) {
  ...
  intake.setVelocity(290, rpm); // 230
  LeftDT.setVelocity(220,rpm);
  RightDT.setVelocity(210,rpm);
  ramp.setVelocity(270, rpm); // 220
...
// move forward
  ...
  LeftDT.spinFor(forward, inchestodegrees(11), degrees, false);
  ...
  LeftDT.spinFor(reverse, inchestodegrees(20), degrees, false);
  RightDT.spinFor(forward, inchestodegrees(20), degrees);

  LeftDT.spinFor(forward, inchestodegrees(70), degrees, false);
  RightDT.spinFor(forward, inchestodegrees(70), degrees);

  // turn 180 degrees

  LeftDT.spinFor(reverse, inchestodegrees(90), degrees, false);
  RightDT.spinFor(forward, inchestodegrees(90), degrees);

  // back up
  LeftDT.spinFor(reverse, inchestodegrees(30), degrees, false);
  RightDT.spinFor(reverse, inchestodegrees(30), degrees);
  // grab mogo

  vex::task::sleep(500);

  LeftDT.spinFor(reverse, inchestodegrees(15), degrees, false);
  RightDT.spinFor(reverse, inchestodegrees(15), degrees);
  ...
  LeftDT.spinFor(forward, inchestodegrees(45), degrees, false);
  RightDT.spinFor(forward, inchestodegrees(45), degrees);


  // turn 180 degrees

  LeftDT.spinFor(forward, inchestodegrees(90), degrees, false);
  RightDT.spinFor(reverse, inchestodegrees(90), degrees);

  // turn towards top bar

  LeftDT.spinFor(forward, inchestodegrees(20), degrees, false);
  RightDT.spinFor(reverse, inchestodegrees(20), degrees);

  // move towards top bar and stop
